...
struct QRCodeWrapper {
    ...
    mutating func clearContent() { _content = nil }
    ...
    fileprivate var _content: QRCodeContent?
...
struct QRCodeContent {
    ...
    mutating func clearVenueType() { _venueType = nil }
    ...
    mutating func clearNotificationKey() { _notificationKey = nil }
    ...
    fileprivate var _venueType: QRCodeContent.VenueType?
    fileprivate var _notificationKey: Data?
}
