...
public struct QRCodeContent {
  ...
  public var venueType: QRCodeContent.VenueType = .other

  public var notificationKey: Data = Data()

  public var validFrom: UInt64 = 0

  public var validTo: UInt64 = 0
...
extension QRCodeContent.VenueType: CaseIterable {
  ...
  public static var allCases: [QRCodeContent.VenueType] = [
    .other,
    .meetingRoom,
    .cafeteria,
    .privateEvent,
...
public struct EntryProof {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var nonce1: Data = Data()

  public var nonce2: Data = Data()
...
extension QRCodeEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "QRCodeEntry"
  ...
  public static func ==(lhs: QRCodeEntry, rhs: QRCodeEntry) -> Bool {
...
extension QRCodeContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "QRCodeContent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: QRCodeContent, rhs: QRCodeContent) -> Bool {
...
extension EntryProof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "EntryProof"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "nonce1"),
    2: .same(proto: "nonce2"),
  ]
  ...
  public static func ==(lhs: EntryProof, rhs: EntryProof) -> Bool {
