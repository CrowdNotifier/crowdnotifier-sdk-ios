...
class CrowdNotifierSDKTests: XCTestCase {
    ...
    private let userUploadInfosTestVector = [
        UserUploadInfo(preId: [102, 168, 6, 51, 148, 105, 27, 207, 161, 224, 198, 28, 198, 237, 58, 28, 226, 147, 154, 0, 242, 43, 27, 25, 156, 86, 75, 3, 236, 153, 174, 216],
                       ...
                       intervalStartMs: 1_620_140_045_000,
                       intervalEndMs: 1_620_140_400_000),
        UserUploadInfo(preId: [102, 168, 6, 51, 148, 105, 27, 207, 161, 224, 198, 28, 198, 237, 58, 28, 226, 147, 154, 0, 242, 43, 27, 25, 156, 86, 75, 3, 236, 153, 174, 216],
                       ...
                       notificationKey: [46, 48, 221, 245, 12, 93, 245, 112, 165, 172, 103, 209, 180, 202, 168, 255, 111, 22, 118, 176, 157, 134, 162, 52, 113, 2, 14, 35, 160, 205, 177, 32],
                       intervalStartMs: 1_620_140_400_000,
                       intervalEndMs: 1_620_144_000_000),
        UserUploadInfo(preId: [102, 168, 6, 51, 148, 105, 27, 207, 161, 224, 198, 28, 198, 237, 58, 28, 226, 147, 154, 0, 242, 43, 27, 25, 156, 86, 75, 3, 236, 153, 174, 216],
                       ...
                       notificationKey: [46, 48, 221, 245, 12, 93, 245, 112, 165, 172, 103, 209, 180, 202, 168, 255, 111, 22, 118, 176, 157, 134, 162, 52, 113, 2, 14, 35, 160, 205, 177, 32],
                       intervalStartMs: 1_620_144_000_000,
                       intervalEndMs: 1_620_147_245_000),
    ]
    ...
    func testUserUploadInfo() {
        let venueInfo = VenueInfo(description: "Description",
                                  ...
                                  validFrom: 1_620_140_045_000,
                                  validTo: 1_620_147_245_000,
        ...
        let infos = CrowdNotifier.generateUserUploadInfo(venueInfo: venueInfo, arrivalTime: Date(millisecondsSince1970: 1_620_140_045_000), departureTime: Date(millisecondsSince1970: 1_620_147_245_000))
